...
public class PruebaYaml implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println("servidor.aplicacion.nombre: "+ readYaml.getApplicacion().get("nombre"));
        ...
        System.out.println("Usuario root username: "+
                readYaml.getUsuarios().get("root").getUsername()+
